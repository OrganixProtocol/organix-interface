const zh = {
  i18n: {
    ...
    maxToMint: '可铸造数量',
    liquidationDesc1: '清算爆仓资产',
    liquidationDesc2: '保障系统安全',
    hour: '小时',
    liqDeadline: '缓冲结束时间',
    maxToLiquidated: '可清算数量',
    liquidatePlaceholder: '清算的OUSD数量',
    yourOusdBalance: '您的OUSD余额',
    noData: '暂无数据',
    ...
    boxTips: '项目启动后，参与挖矿需要在DefiBox重新发起一笔做市操作',
    airTips: '项目启动后，参与挖矿需要在Air重新发起一笔做市操作，增加或减少做市均可',
    startAt: '开始时间',
    details: '说明',
    priceLocked: '反向资产价格已冻结,请等待结算后重置价格'
  }
};
