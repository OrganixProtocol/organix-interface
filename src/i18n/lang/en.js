const en = {
  i18n: {
    ...
    liquidationDesc1: 'Liquidation of',
    liquidationDesc2: 'liquidated assets',
    hour: 'Hour(s)',
    liqDeadline: 'Buffer Deadline',
    maxToLiquidated: 'Amount can be liquidated',
    liquidatePlaceholder: 'OUSD Amount to liquidate',
    yourOusdBalance: 'Your OUSD Balance',
    noData: 'No data',
